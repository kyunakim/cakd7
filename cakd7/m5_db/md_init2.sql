...
/*DROP USER c##cakd7 CASCADE;
CREATE USER c##cakd7 IDENTIFIED BY cakd7 DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp PROFILE DEFAULT;
GRANT CONNECT, RESOURCE TO c##cakd7;
GRANT CREATE VIEW, CREATE SYNONYM TO c##cakd7;
GRANT UNLIMITED TABLESPACE TO c##cakd7;
ALTER USER c##cakd7 ACCOUNT UNLOCK;*/
